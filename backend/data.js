...
const doctors = [
  { id: 1, name: "Dr. Roberto Oliveira", specialty: ["Clínico Geral", "Ortopedia"] },
  { id: 2, name: "Dra. Juliana Mendes", specialty: ["Clínico Geral", "Cardiologia"] },
  { id: 3, name: "Dr. João Pedro", specialty: ["Clínico Geral", "Dermatologia"] },
  { id: 4, name: "Dra. Mariana Silva", specialty: ["Clínico Geral", "Cirurgia Geral"] },
  ...
  { id: 9, name: "Dr. Henrique Almeida", specialty: ["Clínico Geral", "Geriatria"] },
  { id: 10, name: "Dra. Gabriela Mendes", specialty: ["Clínico Geral", "Urologia"] },
  { id: 11, name: "Dr. Pedro Henrique", specialty: ["Cirurgia Cardíaca"] },
  { id: 12, name: "Dra. Renata Medeiros", specialty: ["Urologia"] },
  { id: 13, name: "Dr. Igor Oliveira", specialty: ["Clínico Geral", "Endocrinologia"] },
